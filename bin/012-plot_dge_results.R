...
optionList <- list(
  optparse::make_option(c("-i", "--input_file"),
                        ...
                        help = "File containing DE results. Needs to contain
                          ...
                          pvalue, log2fc, mean_counts, mean_cp10k"
  ),
...
dge_results$significant <- factor(
...
# Currently not plotting volcano plot
# png(
...
# Currently not plotting MA plot
# png(
